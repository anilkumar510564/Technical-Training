...
public class MainController {
    ...
    // This Controller function is for loading the login page
    @GetMapping("login")
    public String logIn(Model model){
        return "login";
    }

    // This Controller function is for loading the registration page
    @GetMapping("registration")
    public String registration(){
        return "registration";
    }

    // This Controller function is for registering user details
    @PostMapping("register")
    public String register(HttpServletRequest request, Model model){
        String name = request.getParameter("InputName");
        String emailId = request.getParameter("InputEmail");
        String phoneNumber = request.getParameter("PhoneNumber");
        int phoneNo=Integer.parseInt(phoneNumber);
        String passWord = request.getParameter("InputPassword");
        User user=new User(name,emailId,phoneNo,passWord);
